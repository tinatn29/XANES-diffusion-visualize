...
points_1_perm3 = points_1.iloc[[3, 0, 1, 2]].reset_index(drop=True)
...
def test_permute_iterate(cluster, ref_cluster, expected_output):
    """Test the permute_iterate function."""
    permuted_cluster = permute_iterate(cluster, ref_cluster)
    print(cluster)
    print(ref_cluster)
