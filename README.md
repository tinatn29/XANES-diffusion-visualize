# XANES-diffusion-visualize

Here is a quick tutorial on how to locally install the package.

## How to install `XANES-diffusion-visualize` locally

`cd` into the project directory:

```bash
cd XANES-diffusion-visualize
```

Create and activate a new conda environment:

```bash
conda create -n xanes-diffusion-visualize_env python=<max_python_version>
conda activate xanes-diffusion-visualize_env
```
